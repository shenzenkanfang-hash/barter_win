...
修复:
  - 在 a_common/src/claint/error.rs 添加 AppError 统一错误枚举
  - 为 EngineError 实现 From<AppError> 转换
  - 为 MarketError 实现 From<AppError> 转换
  - 导出 AppError 供调用方使用

修复日期: 2026-03-25

【ARCH-004】架构文档 V4.0 更新 ✅
文档: `docs/architecture.md` (V4.0)
内容:
  - 新版系统架构图 (八层 + x_data)
  - StateManager / UnifiedStateView 核心组件
  - x_data 完整目录结构
  - 单向依赖链图
  - 验收状态
归档: `docs/archive/20260325_arch_v1/` (14个文件)
