...
impl Kline1dStream {
    /// 创建 1d K线流管理器 (分片订阅: 每批50个，间隔500ms)
    ///
    ...
    pub async fn new(symbols: Vec<String>) -> Result<Self, a_common::MarketError> {
        ...
        tracing::info!(
            "Kline1dStream subscribing to {} symbols in {} batches ({}ms interval)",
            symbols.len(),
        ...
        tracing::info!("Kline1dStream all subscriptions sent, using memory backup dir: {}", base_dir);
