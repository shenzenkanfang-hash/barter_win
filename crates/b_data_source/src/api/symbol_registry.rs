...
impl SymbolRegistry {
    ...
    pub async fn update_symbols(&mut self) -> Result<(), crate::MarketError> {
        // Mock 模式下跳过更新
        if self.is_mock {
        ...
        let resp = client
            ...
            .send()
            .await
            .map_err(|e| crate::MarketError::NetworkError(e.to_string()))?;

        let info: serde_json::Value = resp
            .json()
            .await
            .map_err(|e| crate::MarketError::ParseError(e.to_string()))?;
