...
use super::account::{Account, Side};
...
mod tests {
    ...
    fn test_open_position() {
        let mut engine = OrderEngine::new(dec!(100000.0), &ShadowConfig::default());
    ...
    fn test_insufficient_balance() {
        let mut engine = OrderEngine::new(dec!(1000.0), &ShadowConfig::default());
